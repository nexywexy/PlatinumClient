namespace Newtonsoft.Json.Linq.JsonPath
{
    ...
    internal class ArrayMultipleIndexFilter : PathFilter
    {
        ...
        private sealed class <ExecuteFilter>d__4 : IEnumerable<JToken>, IEnumerable, IEnumerator<JToken>, IDisposable, IEnumerator
        {
                ...
                try
                {
                    ...
                    if (num == 0)
                    {
                        ...
                        while (this.<>7__wrap1.MoveNext())
                        {
                            ...
                            this.<>7__wrap2 = this.<>4__this.Indexes.GetEnumerator();
                            this.<>1__state = -4;
                            while (this.<>7__wrap2.MoveNext())
                            {
                                int current = this.<>7__wrap2.Current;
                                JToken token = PathFilter.GetTokenIndex(this.<t>5__1, this.errorWhenNoMatch, current);
                                if (token == null)
                                {
                                    continue;
                                }
                            ...
                            this.<>m__Finally2();
                            this.<>7__wrap2 = new List<int>.Enumerator();
                            this.<t>5__1 = null;
                        }
                        this.<>m__Finally1();
                        this.<>7__wrap1 = null;
            ...
            {
                ArrayMultipleIndexFilter.<ExecuteFilter>d__4 d__;
                ...
                {
                    d__ = new ArrayMultipleIndexFilter.<ExecuteFilter>d__4(0) {
